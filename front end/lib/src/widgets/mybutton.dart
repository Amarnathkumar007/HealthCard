...
class MyButton extends StatelessWidget {
  const MyButton({ Key key, this.onTap, this.title = "", this.width = double.infinity, this.height = 45, this.bgColor = primary, this.icon, this.disableButton = true, this.isLoading = false}) : super(key: key);
        ...
        child: GestureDetector(
          ...
          Container(
              ...
              Row(
                  ...
                  children: isLoading ?
                  [SizedBox(width: 20, height: 20, child: CircularProgressIndicator(Colors: Colors.white, strokeWidth: 3,))] :
                  (icon == null) ?
                  [
